...
TemperatureData::TemperatureData(
    ::google::protobuf::Arena* arena,
    const TemperatureData& from)
    : ::google::protobuf::Message(arena) {
  TemperatureData* const _this = this;
  (void)_this;
  _internal_metadata_.MergeFrom<::google::protobuf::UnknownFieldSet>(
      from._internal_metadata_);
...
inline void TemperatureData::SharedCtor(::_pb::Arena* arena) {
...
const char* TemperatureData::_InternalParse(
...
const ::_pbi::TcParseTable<1, 2, 0, 37, 2> TemperatureData::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastUS1,
     {18, 63, 0, PROTOBUF_FIELD_OFFSET(TemperatureData, _impl_.timestamp_)}},
    // float temperature = 1;
    {::_pbi::TcParser::FastF32S1,
     {13, 63, 0, PROTOBUF_FIELD_OFFSET(TemperatureData, _impl_.temperature_)}},
  }}, {{
    65535, 65535
  }}, {{
    // float temperature = 1;
    {PROTOBUF_FIELD_OFFSET(TemperatureData, _impl_.temperature_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kFloat)},
    // string timestamp = 2;
    {PROTOBUF_FIELD_OFFSET(TemperatureData, _impl_.timestamp_), 0, 0,
...
const ::google::protobuf::Message::ClassData TemperatureData::_class_data_ = {
    TemperatureData::MergeImpl,
    nullptr,  // OnDemandRegisterArenaDtor
};
const ::google::protobuf::Message::ClassData* TemperatureData::GetClassData() const {
  return &_class_data_;
}
...
PROTOBUF_NOINLINE bool TemperatureData::IsInitialized() const {
  return true;
}

::_pbi::CachedSize* TemperatureData::AccessCachedSize() const {
  return &_impl_._cached_size_;
}
void TemperatureData::InternalSwap(TemperatureData* PROTOBUF_RESTRICT other) {
  using std::swap;
  auto* arena = GetArena();
